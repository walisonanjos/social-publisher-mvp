...
// VERSÃO CORRIGIDA - Agora não tenta autenticar o usuário, pois é um callback do Google
...
    // --- ETAPA 2: Usar o access_token para buscar o ID do Canal ---
...
    // --- Etapa 3: Salvar TUDO no banco de dados com o cliente admin ---
...
    console.error("ERRO FINAL NO BLOCO CATCH:", message);
