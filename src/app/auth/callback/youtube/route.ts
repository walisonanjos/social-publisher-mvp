...
// Note que este Edge Function você já me enviou: supabase/functions/exchange-auth-code/index.ts

// Função auxiliar para determinar a URL de redirecionamento final
...
export async function GET(request: Request) {
    ...
    try {
        ...
        // Se a função Edge for bem-sucedida, ela já redireciona para /niche/:nicheId
        // O corpo da resposta da Edge Function deve ser ignorado aqui, pois ela faz o redirect.
        
        // CORREÇÃO: O seu Edge Function de YouTube já retorna um redirect (Status 303). 
        // Aqui, nós apenas garantimos que o navegador siga o redirect.
        ...
        // Fallback: Redireciona manualmente para o nicho se não houver Location no header
