// src/app/error/ErrorContent.tsx
"use client"; // INDICA QUE ESTE É UM CLIENT COMPONENT

import { useEffect, useState } from 'react';
import { useSearchParams } from 'next/navigation'; // Hook problemático movido para cá
import Link from 'next/link';

export default function ErrorContent() { // Componente renomeado
  ...
  useEffect(() => {
    ...
    if (message) {
      setErrorMessage(decodeURIComponent(message.replace(/_/g, ' ')));
    }
    if (details) {
      setErrorDetails(decodeURIComponent(details.replace(/_/g, ' ')));
    }
  }, [searchParams]);
